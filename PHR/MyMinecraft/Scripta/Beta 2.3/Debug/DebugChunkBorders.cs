...
public class DebugChunkBorders : MonoBehaviour
{
    ...
    void OnRenderObject()
    {
        ...
        // Draw borders
        Vector2 playerChunk = playerCharacter.GetWorldPosXZ() * 16;
        DrawChunkEdge(new(playerChunk.x, 0, playerChunk.y));
        DrawPlayerChunkBorder(new(playerChunk.x, 0, playerChunk.y));
