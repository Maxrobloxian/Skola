...
public class PerformanceStats : MonoBehaviour
{
    ...
    {
        chunkDataLoadTime.Add(chunkPos, gameLoad.Elapsed.TotalMilliseconds);
    }
    ...
    {
        chunkRenderLoadTime.Add(chunkPos, gameLoad.Elapsed.TotalMilliseconds);
    }
