...
public static class BlockHelper
{
    ...
    internal static void SetBlockSide(Direction direction, int x, int y, int z, MeshData meshData, BlockType blockType)
    {
    ...
    static void SetFaceVertices(Direction direction, int x, int y, int z, MeshData meshData, BlockType blockType)
    {
        ...
        switch (direction)
        {
            case Direction.backward:
                meshData.AddVertex(new Vector3(x, y, z), isCollider);
                meshData.AddVertex(new Vector3(x, y + 1f, z), isCollider);
                meshData.AddVertex(new Vector3(x + 1f, y + 1f, z), isCollider);
                meshData.AddVertex(new Vector3(x + 1f, y, z), isCollider);
                break;
            case Direction.forward:
                meshData.AddVertex(new Vector3(x + 1f, y, z + 1f), isCollider);
                meshData.AddVertex(new Vector3(x + 1f, y + 1f, z + 1f), isCollider);
                meshData.AddVertex(new Vector3(x, y + 1f, z + 1f), isCollider);
                meshData.AddVertex(new Vector3(x, y, z + 1f), isCollider);
                break;
            case Direction.left:
                meshData.AddVertex(new Vector3(x, y, z + 1f), isCollider);
                meshData.AddVertex(new Vector3(x, y + 1f, z + 1f), isCollider);
    ...
    internal static Vector2[] FaceUVs(Direction direction, BlockType blockType)
    {
