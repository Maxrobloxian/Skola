...
public static class PlayerSettings
{
    ...
    public static int maxAmountPerSlot = 128;

    // Player interaction
    public static int interactionRange = 5;

    internal static void AddData(PlayerInventory playerInventory, PlayerInputs playerInputs, PlayerChunksManager playerChunksManager, PlayerCharacter playerCharacter, PlayerInteractions playerInteractions, PlayerCamera playerCamera)
    {
