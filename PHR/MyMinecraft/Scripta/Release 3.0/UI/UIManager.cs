...
public class UIManager : MonoBehaviour
{
    ...
    {
        image.color = new Color(.85f, .85f, .85f);
    }
    ...
    internal void BackActionInput(InputAction.CallbackContext context)
    {
        BackAction();
    }
    ...
    {
        if (parentCounter.GetActiveCount() <= 0) TogglePauseMenu(true);
        else if (inMenu)
        {
            CloseUIMenu();
